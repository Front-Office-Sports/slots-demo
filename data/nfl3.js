const dataList = [
  // Cities
  [
    {text: "Glendale", image: "images/cities/Arizona Cardinals.jpeg", team_name: "Arizona Cardinals"},
    {text: "Atlanta", image: "images/cities/Atlanta Falcons.jpeg", team_name: "Atlanta Falcons"},
    {text: "Baltimore", image: "images/cities/Baltimore Ravens.png", team_name: "Baltimore Ravens"},
    {text: "Orchard Park", image: "images/cities/Buffalo Bills.jpeg", team_name: "Buffalo Bills"},
    {text: "Charlotte", image: "images/cities/Carolina Panthers.jpeg", team_name: "Carolina Panthers"},
    {text: "Chicago", image: "images/cities/Chicago Bears.jpeg", team_name: "Chicago Bears"},
    {text: "Cincinnati", image: "images/cities/Cincinnati Bengals.jpeg", team_name: "Cincinnati Bengals"},
    {text: "Cleveland", image: "images/cities/Cleveland Browns.jpeg", team_name: "Cleveland Browns"},
    {text: "Arlington", image: "images/cities/Dallas Cowboys.jpg", team_name: "Dallas Cowboys"},
    {text: "Denver", image: "images/cities/Denver Broncos.jpg", team_name: "Denver Broncos"},
    {text: "Detroit", image: "images/cities/Detroit Lions.jpeg", team_name: "Detroit Lions"},
    {text: "Green Bay", image: "images/cities/Green Bay Packers.jpeg", team_name: "Green Bay Packers"},
    {text: "Houston", image: "images/cities/Houston Texans.jpeg", team_name: "Houston Texans"},
    {text: "Indianapolis", image: "images/cities/Indianapolis Colts.jpeg", team_name: "Indianapolis Colts"},
    {text: "Jacksonville", image: "images/cities/Jacksonville Jaguars.jpeg", team_name: "Jacksonville Jaguars"},
    {text: "Kansas City", image: "images/cities/Kansas City Chiefs.png", team_name: "Kansas City Chiefs"},
    {text: "Paradise", image: "images/cities/Las Vegas Raiders.jpeg", team_name: "Las Vegas Raiders"},
    // {text: "Inglewood", image: "", team_name: "Los Angeles Chargers"},
    {text: "Inglewood", image: "images/cities/Los Angeles Rams.png", team_name: "Los Angeles Rams"},
    {text: "Miami Gardens", image: "images/cities/Miami Dolphins.jpeg", team_name: "Miami Dolphins"},
    {text: "Minneapolis", image: "images/cities/Minnesota Vikings.jpg", team_name: "Minnesota Vikings"},
    {text: "Foxborough", image: "images/cities/New England Patriots.jpeg", team_name: "New England Patriots"},
    {text: "New Orleans", image: "images/cities/New Orleans Saints.jpeg", team_name: "New Orleans Saints"},
    {text: "East Rutherford", image: "images/cities/New York Giants.png", team_name: "New York Giants"},
    // {text: "East Rutherford", image: "", team_name: "New York Jets"},
    {text: "Philadelphia", image: "images/cities/Philadelphia Eagles.jpeg", team_name: "Philadelphia Eagles"},
    {text: "Pittsburgh", image: "images/cities/Pittsburgh Steelers.jpg", team_name: "Pittsburgh Steelers"},
    {text: "Santa Clara", image: "images/cities/San Francisco 49ers.jpeg", team_name: "San Francisco 49ers"},
    {text: "Seattle", image: "images/cities/Seattle Seahawks.jpeg", team_name: "Seattle Seahawks"},
    {text: "Tampa", image: "images/cities/Tampa Bay Buccaneers.png", team_name: "Tampa Bay Buccaneers"},
    {text: "Nashville", image: "images/cities/Tennessee Titans.jpeg", team_name: "Tennessee Titans"},
    {text: "Landover", image: "images/cities/Washington Redskins.png", team_name: "Washington Redskins"}
  ],
  // Team Owners
  [
    ...
    {text: "Virginia Halas McCaskey", image: "images/owners/Virginia Halas McCaskey.jpeg"},
    ...
    {text: "Stephen Michael Ross", image: "images/owners/Stephen Michael Ross.jpeg"},
    ...
    {text: "Denise DeBartolo York", image: "images/owners/Denise DeBartolo York.jpg"},
